export function level5(k, music) {
  ...
  sandboxContainer.innerHTML = `
    <div style="display: flex; align-items: center; margin-bottom: 24px;">
      ...
      <h3 style="margin: 0; font-weight: 500; font-size: 16px; color: #bdc3c7;">Traversal Sum</h3>
    </div>
    ...
    <span class="code"><span class="keyword">function</span> <span class="function">sumNodes</span>() {</span>
    </div>
    ...
    <div class="code-line" data-line="3">
        ...
        <span class="code">    <span class="keyword">let</span> sum <span class="operator">=</span> 0;</span>
    </div>
    ...
    <div class="code-line" data-line="6">
        ...
        <span class="code">     sum   <span class="operator">+=</span> current.data</span>
    </div>
    ...
    <div class="code-line" data-line="10">
        ...
        <span class="code">    <span class="keyword">return</span> sum;</span>
    </div>
    ...
    <div style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
      ...
      <div style="font-size: 12px; color: #6272a4;">Level 5</div>
    </div>
  `;
    k.scene("level5", () => {
        let bogies = [
                    ...
                    if (currentBogieIndex === bogies.length) {
                        ...
                        setTimeout(() => {
                            ...
                            submitButton.addEventListener("click", () => {
                                ...
                                sum = bogies.reduce((accumulator, currentBogie) => accumulator + currentBogie.value, 0);
