export function level8(k, music) {
  ...
  sandboxContainer.innerHTML = `
    <div style="display: flex; align-items: center; margin-bottom: 24px;">
      ...
      <h3 style="margin: 0; font-weight: 500; font-size: 16px; color: #bdc3c7;">Deletion At End</h3>
    </div>
    <div class="code-display">
      ...
      <div class="code-line" data-line="1">
          ...
          <span class="code"><span class="keyword">function</span> <span class="function">deleteAtEnd</span>() {</span>
      </div>
      ...
      <div class="code-line" data-line="3">
          ...
          <span class="code">    <span class="keyword">while</span> (current.next.next <span class="operator">!==</span> <span class="keyword">null</span>) {</span>
      </div>
      ...
      <div class="code-line" data-line="6">
          ...
          <span class="code">    <span class="keyword">let</span> lastNode <span class="operator">=</span> current.next;</span>
      </div>
      <div class="code-line" data-line="7">
          <span class="line-number">7</span>
          <span class="code">    current.next <span class="operator">=</span> <span class="keyword">null</span>;</span>
      </div>
      <div class="code-line" data-line="8">
          <span class="line-number">8</span>
          <span class="code">    lastNode <span class="operator">=</span> <span class="keyword">null</span>;</span>
      </div>
    ...
    <div style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
      ...
      <div style="font-size: 12px; color: #6272a4;">Level 8</div>
    </div>
  `;
    ...
    function drawInstructions() {
      ...
      switch (gameState) {
        ...
        case "JUMP":
          ...
          k.drawText({
            text: "Reach before the last bogie!",
            pos: k.vec2(130, 240),
            color: k.rgb(0, 0, 0),
            size: 24,
            font: "myFont",
    ...
    k.onKeyPress("space", () => {
      ...
      if (gameState === "JUMP") {
        ...
        if (currentBogieIndex < bogies.length) {
          ...
          if (currentBogieIndex === bogies.length - 1) {
    ...
    k.onUpdate(() => {
      ...
      if (gameState === "BOMB") {
        ...
        if (k.isMouseDown()) {
          ...
          if (
            Math.abs(chainPosition.x - ((bogies[bogies.length - 1].x) + 25)) < 10 &&
            ...
            setTimeout(() => {
              if (score === 30) {
                ...
                k.go('end', { nextLevel: 'level9', currentLevel: 'level8' })
              }
