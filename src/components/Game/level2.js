export function level2(k, music) {
  ...
  sandboxContainer.innerHTML = `
    <div style="display: flex; align-items: center; margin-bottom: 24px;">
      ...
      <h3 style="margin: 0; font-weight: 500; font-size: 16px; color: #bdc3c7;">Insertion At End</h3>
    </div>
    ...
    <span class="code"><span class="keyword">function</span> <span class="function">insertAtEnd</span>(<span class="object">data</span>) {</span>
  </div>
    ...
    k.onUpdate(() => {
      ...
      if (gameState !== prevGameState) {
        if (gameState === "SELECT_NUMBER") {
          ...
          highlightLine(4);
        } else if (gameState === "ATTACHED" || gameState === "LINK") {
          highlightLine(7);
        }
