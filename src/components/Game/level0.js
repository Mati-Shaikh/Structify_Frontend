export function level0(k, music) {
  ...
  sandboxContainer.innerHTML = `
    <div style="display: flex; align-items: center; margin-bottom: 24px;">
      ...
      <h3 style="margin: 0; font-weight: 500; font-size: 16px; color: #bdc3c7;">Stack Push Operation</h3>
    </div>
    <div class="code-display">
      ...
      <div class="code-line" data-line="1">
        ...
        <span class="code"><span class="keyword">function</span> <span class="function">push</span>(<span class="object">data</span>) {</span>
      </div>
      <div class="code-line" data-line="2">
        <span class="line-number">2</span>
        <span class="code">    stack.push(data);</span>
      </div>
    ...
    k.onUpdate(() => {
      ...
      if (gameState === "MOVE_ELEMENT") {
        ...
        if (k.isKeyPressed("space")) {
          // If the stack is empty, set the initial position for the first item
          if (stack.length === 0) {
            stack.unshift({ x: 300, y: 350, value: newElement.value });
          } else {
            // Shift all existing elements down by 70 pixels
            stack.forEach((element) => {
              element.y += 70;
            });
    
            // Add the new element to the top of the stack on the LEFT side
            stack.unshift({ x: 300, y: stack[0].y - 70, value: newElement.value });
          }
          ...
          setTimeout(() => {
            if (score === 30) {
              ...
              k.go('end', { nextLevel: 'level2', currentLevel: 'Stack1' });
            }
